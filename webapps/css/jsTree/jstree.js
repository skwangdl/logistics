	...
	$.jstree.core.prototype = {
		...
		toggle_node : function (obj) {
			...
			if(this.is_open(obj)) {
				...
				this._model.data[this.get_node(obj).id].state.loaded = false;
	...
	(function ($) {
		...
		$.vakata.context = {
			...
			_show_submenu : function (o) {
				...
				// Ñ}ÑÄÑwÑu ÑtÑp ÑÉÑu ÑÉÑÅÑuÑÉÑÑÑy Ñu ÑuÑtÑ~Ñp ÑÅÑÇÑÄÑrÑuÑÇÑ{Ñp - ÑtÑpÑ|Ñy Ñ~ÑëÑ}Ñp Ñ~ÑëÑ{ÑÄÑz ÑÄÑÑ Ñ{Ñ|ÑpÑÉÑÄÑrÑuÑÑÑu ÑrÑuÑâÑu Ñ~ÑpÑsÑÄÑÇÑu
				if(right_to_left) {
			...
			vakata_context.element
				.on("mouseenter", "li", function (e) {
					...
					if($.contains(this, e.relatedTarget)) {
						// ÑÅÑÇÑuÑ}ÑpÑáÑ~ÑpÑÑÑÄ ÑxÑpÑÇÑpÑtÑy delegate mouseleave ÑÅÑÄ-ÑtÑÄÑ|ÑÖ
				...
				// ÑÑÑuÑÉÑÑÑÄÑrÑÄ - ÑtÑpÑ|Ñy Ñ~Ñu Ñ~ÑpÑÑÑÄÑrÑpÑÇÑrÑp?
